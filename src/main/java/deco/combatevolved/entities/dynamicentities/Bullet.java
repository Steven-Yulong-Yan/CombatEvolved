...
public class Bullet extends DynamicEntity {
    ...
    // Delay between the player's bullets
    private static final long FIRE_DELAY = 500;

    // Velocity of the bullet
    public static final long VELOCITY = 20;

    // Last time the player fired a bullet
    private static long lastFire = 0;

    private final HexVector bulletPosition;
    private final HexVector initialPosition;

    private final HexVector bulletVelocity;
    ...
    public static void keyUpdate(List<Bullet> bullets, PlayerPeon player) {
        ...
        // Cet the direction to fire the bullet and change the magnitude to 20
